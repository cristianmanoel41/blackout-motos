...
import CabecalhoNovo from "@/components/novo/CabecalhoNovo";
import VitrineNovo from "@/components/novo/VitrineNovo";

/*
 * A versão trabalhada - só no localhost, em /novo.
 *
 * O site no ar continua como está. Aqui a aposta é outra: em
 * vez de seções iguais empilhadas, cada bloco tem um ritmo
 * próprio, a foto sangra para fora do texto e o preço aparece
 * com corpo de manchete.
 *
 * O estoque é o mesmo do site - não há tela de mentira aqui.
 *
 * Moto aparece uma vez só: um card, as destaques passando
 * sozinhas dentro dele. Duas fotos de moto na primeira tela
 * disputavam entre si e ninguém sabia para onde olhar.
 */
  ...
  return (
    <>
          ...
          <div className="mx-auto grid max-w-[1400px] items-center gap-10 px-5 pb-16 pt-6 sm:px-8 lg:grid-cols-[1.1fr_1fr] lg:gap-6 lg:pb-24">
            <div className="sobe relative z-10">
              ...
              <p className="mt-6 max-w-md text-[1.05rem] leading-8 suave">
                ...
                conferida e documentação resolvida pela loja.
                Você escolhe, a gente cuida do resto.
              </p>
            ...
            {/*
              * A vitrine ocupa o lugar que era da foto
              * parada. No celular ela vem antes do texto:
              * quem abre o site quer ver moto, não ler.
              */}
            {destaques.length > 0 && (
      ...
      <footer className="border-t border-white/10 px-5 py-8 sm:px-8">
        <div className="mx-auto flex max-w-[1400px] flex-wrap items-center justify-between gap-3 text-[13px] suave">
          <p>
