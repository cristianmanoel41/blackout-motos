...
function dataBrasil(data: string | null) {
  if (!data) return "-";
      ...
      <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-texto-suave">
            Consulte todas as vendas registradas.
          </p>
        </div>
